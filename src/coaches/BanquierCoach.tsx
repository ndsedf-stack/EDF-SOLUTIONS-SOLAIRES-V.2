  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed z-[9999] bottom-6 left-6 flex items-center gap-1.5 px-2 py-1 
          bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 
          rounded-md transition-all
          ${
            isOpen
              ? "opacity-100 bg-emerald-600/20 border-emerald-500/30"
      ...
      {isOpen && (
        <div
          className="fixed right-0 top-0 bottom-0 w-[460px] bg-zinc-900 border-l border-white/10 p-6 z-[9998] overflow-y-auto"
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            >
              {currentPhase === banquierPhases.length - 1
                ? "Terminer"
                : "Suivant"}
            </button>
          </div>
