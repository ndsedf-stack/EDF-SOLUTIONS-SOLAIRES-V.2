  ...
  return (
    <svg width={width} height={height}>
      <Group left={margin.left} top={margin.top}>
        ...
        {/* Zone Projetée (Delta) -> Corridor de Confiance */}
        <AreaClosed<ProjectionPoint>
          data={data}
          x={d => xScale(d.date)}
          ...
          curve={curveMonotoneX}
        />
        {/* ✅ AUDIT FIX ID: PESSIMISTIC_INVISIBLE -> Explicit Confidence Bounds */}
        <LinePath<ProjectionPoint>
          data={data}
          x={d => xScale(d.date)}
          y={d => yScale(d.secured) + 5} // Lower bound visual
        ...
        <LinePath<ProjectionPoint>
          data={data}
          x={d => xScale(d.date)}
          y={d => yScale(d.projected)} // Upper bound
          stroke={COLORS.projected}
          strokeWidth={1}
          strokeDasharray="4 4"
          strokeOpacity={0.3}
        ...
        {/* Ligne Projetée (Moyenne) */}
        <LinePath<ProjectionPoint>
          data={data}
          x={d => xScale(d.date)}
          y={d => yScale((d.secured + d.projected) / 2)} // Center line
          stroke={COLORS.projected}
          strokeWidth={2}
          strokeDasharray="4,2"
          curve={curveMonotoneX}
