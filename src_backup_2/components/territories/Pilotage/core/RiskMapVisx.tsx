  ...
  return (
    <div className="relative" style={{ width, height }}>
      <svg width={width} height={height} className="bg-[#0A0E27] cursor-crosshair">
        ...
        <Group>
            {/* RÉCUPÉRABLE — ✅ CORRECTION V17: Increased opacity */}
            <rect x={xScale(0)} width={xScale(7) - xScale(0)} y={margin.top} height={height - margin.top - margin.bottom} fill="#4ADE80" fillOpacity={0.04} />
            <text x={xScale(3.5)} y={height - margin.bottom + 40} fill="#4ADE80" fillOpacity={0.6} fontSize={11} fontWeight="bold" textAnchor="middle" className="uppercase tracking-[0.2em] font-sans">✅ Récupérable</text>
            
            {/* TENSION */}
            <rect x={xScale(7)} width={xScale(14) - xScale(7)} y={margin.top} height={height - margin.top - margin.bottom} fill="#FB923C" fillOpacity={0.05} />
            <text x={xScale(10.5)} y={height - margin.bottom + 40} fill="#FB923C" fillOpacity={0.6} fontSize={11} fontWeight="bold" textAnchor="middle" className="uppercase tracking-[0.2em] font-sans">⚠️ Tension</text>
            
            {/* CRITIQUE */}
            <rect x={xScale(14)} width={width - margin.right - xScale(14)} y={margin.top} height={height - margin.top - margin.bottom} fill="#F87171" fillOpacity={0.08} />
            <text x={xScale(22)} y={height - margin.bottom + 40} fill="#F87171" fillOpacity={0.6} fontSize={11} fontWeight="bold" textAnchor="middle" className="uppercase tracking-[0.2em] font-sans">🔥 Critique</text>
        </Group>
